(function () {
  const sheetPembeliURL = 'https://script.google.com/macros/s/AKfycbxVgwRqAqmKBXnhetkZ2g3JbXofSPFy3oQxh1b9mln1OoinsUzjjoD2Fxf3F6JTKH6ZtA/exec?sheet=DataPembeli';
  let rowData = [];
  let deleteIndex = -1;
