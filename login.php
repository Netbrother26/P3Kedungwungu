        ...
        <div class="card border-light-subtle shadow-sm">
          <div class="row g-0">
            <div class="col-12 col-md-6">
              <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="views/images/kontruksi.jpg" alt="Welcome back you've been missed!">
            </div>
                    ...
                    <div class="col-12">
                      <div class="mb-5">
                        <div class="text-center mb-4">
                          <a href="#!">
                            <img src="views/images/logo4.png" alt="P3 Logo" width="175" height="107">
                          </a>
                        </div>
